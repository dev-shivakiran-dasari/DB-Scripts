...
CREATE PROC [dbo].[USP_Notification_RealTime_YouTube]
AS 
BEGIN
...
INNER JOIN 
    Event_NotificationSetting ENS WITH(NOLOCK) on ENS.UserID = UD.UserID and ENS.EventID = eu.EventID  and ENS.PlatformID = 1 
                                              and ENS.IsActive = 1 and ENS.Platform_IsActive = 1 and ENS.Platform_AsItHappens=1 
...
and PlatformID=1 and ENS.IsActive=1 and ENS.Platform_IsActive=1 and ENS.Platform_AsItHappens=1  ) as LastModifiedAt
