...
from [dbo].[Event_LinkOnline_Summary] a with(nolock)
INNER JOIN Event b with(nolock) on a.eventid=b.eventid
where a.EventID in (2345,2348,2349,2350,2351,2352) and a.peakid>0
and createdat >='2026-01-05'
order by a.eventid
...
BEGIN
	...
	exec [dbo].[USP_API_SentryV2_Event_TimelinePeak_FetchTimeLine_Shubham_16042025_Shiv]  @EventID,@FromDate,@ToDate,'Online',@type='all'
